...
export default function FoundationPageClient({
  ...
  const {
    ...
    setPlayerScope, playerTeamFilter, setPlayerTeamFilter, playerClassFilter, setPlayerClassFilter, marketClassFilter, setMarketClassFilter, marketRaceFilter, setMarketRaceFilter, marketSubclassFilter,
    ...
    setAiPreseasonBusy, aiPreseasonFeed, setAiPreseasonFeed, aiLineupEnsureBusy, setAiLineupEnsureBusy, aiLineupEnsureFeed, setAiLineupEnsureFeed, aiPickAuditBusy, setAiPickAuditBusy, aiPickAuditFeed,
