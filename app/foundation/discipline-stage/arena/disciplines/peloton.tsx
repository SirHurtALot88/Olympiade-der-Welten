// STUB · peloton — aktuelle Feld-Darstellung 1:1 aus dem Host, delegiert an FieldSvgInner.
// Fan-out-Agent: hier die bespoke Feld-Optik/Bewegung für "peloton" bauen (Contract:
