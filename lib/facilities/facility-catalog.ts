...
export const FACILITY_CATALOG: FacilityCatalogEntry[] = [
  ...
  },
  {
    ...
    levels: [
      { level: 1, effectDescription: "+5% Recovery", upgradeCost: 7, seasonUpkeep: 0.7, modifierPct: 5 },
      { level: 2, effectDescription: "+10% Recovery", upgradeCost: 13, seasonUpkeep: 1.2, modifierPct: 10 },
      { level: 3, effectDescription: "+15% Recovery", upgradeCost: 22, seasonUpkeep: 2.1, modifierPct: 15 },
      { level: 4, effectDescription: "+20% Recovery", upgradeCost: 35, seasonUpkeep: 3.3, modifierPct: 20 },
      { level: 5, effectDescription: "+25% Recovery", upgradeCost: 54, seasonUpkeep: 4.8, modifierPct: 25 },
    ],
  },
  {
  ...
  },
  {
    ...
    levels: [
      { level: 1, effectDescription: "+2.5 Cash/Saison", upgradeCost: 7, seasonUpkeep: 0.4, seasonIncome: 2.5 },
      { level: 2, effectDescription: "+5 Cash/Saison", upgradeCost: 14, seasonUpkeep: 0.8, seasonIncome: 5 },
      { level: 3, effectDescription: "+8 Cash/Saison", upgradeCost: 23, seasonUpkeep: 1.4, seasonIncome: 8 },
      { level: 4, effectDescription: "+12 Cash/Saison", upgradeCost: 36, seasonUpkeep: 2.2, seasonIncome: 12 },
      { level: 5, effectDescription: "+18 Cash/Saison", upgradeCost: 56, seasonUpkeep: 3.4, seasonIncome: 18 },
    ],
  },
  {
    ...
    levels: [
      { level: 1, effectDescription: "+3 Cash/Saison", upgradeCost: 10, seasonUpkeep: 0.8, seasonIncome: 3 },
      { level: 2, effectDescription: "+6 Cash/Saison", upgradeCost: 18, seasonUpkeep: 1.4, seasonIncome: 6 },
      { level: 3, effectDescription: "+10 Cash/Saison", upgradeCost: 30, seasonUpkeep: 2.4, seasonIncome: 10 },
      { level: 4, effectDescription: "+15 Cash/Saison", upgradeCost: 46, seasonUpkeep: 3.6, seasonIncome: 15 },
      { level: 5, effectDescription: "+22 Cash/Saison", upgradeCost: 72, seasonUpkeep: 5.4, seasonIncome: 22 },
    ],
  },
  {
    facilityId: "academy",
