...
export type FoundationSaveScopedFeedSetters = {
  setMarketFeed: Dispatch<SetStateAction<any>>;
  setMarketRenderLimit: Dispatch<SetStateAction<number>>;
  setMarketLoadingMore: Dispatch<SetStateAction<boolean>>;
  setMarketBuyPreview: Dispatch<SetStateAction<any>>;
  setMarketBuyPreviewContext: Dispatch<SetStateAction<any>>;
  ...
  setMarketSellSubject: Dispatch<SetStateAction<any>>;
  setMarketSellRiskAcknowledged: Dispatch<SetStateAction<boolean>>;
  setMarketAiPreviewFeed: Dispatch<SetStateAction<any>>;
  setMarketAiSellPreviewFeed: Dispatch<SetStateAction<any>>;
  setMarketAiPlanPreviewFeed: Dispatch<SetStateAction<any>>;
  setMarketAiCompareFeed: Dispatch<SetStateAction<any>>;
  setMarketAiApplyFeed: Dispatch<SetStateAction<any>>;
  setRosterFillFeed: Dispatch<SetStateAction<any>>;
  setAiPreseasonFeed: Dispatch<SetStateAction<any>>;
  setAiPreseasonBusy: Dispatch<SetStateAction<boolean>>;
  setAiPickAuditFeed: Dispatch<SetStateAction<any>>;
  setSeasonStartResetFeed: Dispatch<SetStateAction<any>>;
  setHistoryFeed: Dispatch<SetStateAction<any>>;
  setHistorySeasonFilter: Dispatch<SetStateAction<string>>;
  setTransferRecapFeed: Dispatch<SetStateAction<any>>;
  setResolvePreviewFeed: Dispatch<SetStateAction<any>>;
  setCockpitAiBatchApplyFeed: Dispatch<SetStateAction<any>>;
  setMatchdayMvpScoringFeed: Dispatch<SetStateAction<any>>;
  setResultApplyFeed: Dispatch<SetStateAction<any>>;
  setStandingsPreviewFeed: Dispatch<SetStateAction<any>>;
  setStandingsApplyFeed: Dispatch<SetStateAction<any>>;
  setSeasonManagementFeed: Dispatch<SetStateAction<any>>;
  setFacilityUpgradePreview: Dispatch<SetStateAction<any>>;
  setFacilityUpgradeError: Dispatch<SetStateAction<string | null>>;
  setFacilityUpgradeSuccess: Dispatch<SetStateAction<string | null>>;
  setPreSeasonWorkflowFeed: Dispatch<SetStateAction<any>>;
  setPreSeasonWorkflowError: Dispatch<SetStateAction<string | null>>;
  setSeasonTransitionFeed: Dispatch<SetStateAction<any>>;
  ...
  setMatchdayAutoRunFeed: Dispatch<SetStateAction<any>>;
  setWholeSeasonDryRunFeed: Dispatch<SetStateAction<any>>;
  setSeasonSnapshotFeed: Dispatch<SetStateAction<any>>;
  ...
  setFoundationActionFeedback: Dispatch<SetStateAction<any>>;
};
