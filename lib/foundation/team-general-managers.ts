...
const archetypeSeeds: GmSeed[] = [
  {
    ...
    lineupDoctrine: "Solide Einsätze, wenig Push-Risiko bei teuren Assets.",
    bias: {
      cashPriority: 10,
      valuePriority: 10,
      wageSensitivity: 10,
  ...
  },
  {
    ...
    lineupDoctrine: "Gibt Prospects echte Einsätze, wenn der Saisonplan es erlaubt.",
    bias: {
      valuePriority: 8,
  ...
  },
  {
    ...
    descriptionRoot: "Denkt strukturell: Gebäude, Staff, Training und nachhaltige Infrastruktur vor Panikkaeufen.",
    pow: 3,
    spe: 3,
    men: 10,
    soc: 4,
  ...
  },
  {
    ...
    descriptionRoot: "Schützt Teamchemie, Zufriedenheit und langfristige Bindung stärker als reine Tabellenarithmetik.",
    pow: 2,
    spe: 3,
    men: 5,
    soc: 10,
  ...
  },
  {
    ...
    facilityPriorities: ["arena_ops", "performance_lab", "scouting_room"],
    marketDoctrine: "Kauft gezielt gegen Rivalen und direkte Ranking-Lücken.",
