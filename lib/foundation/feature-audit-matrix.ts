...
const registry: RegistryInput[] = [
  ...
  },
  {
    ...
    category: "Team Management",
    status: "sandbox_ready",
    views: ["home", "teams", "market", "training", "lineup", "arena"],
    ...
    multiplayerReady: true,
	  ...
	  },
	  {
	    ...
	    writePaths: [],
	    testCoverage: ["game-inbox-service.test.ts", "game-inbox-ui-contract.test.ts"],
	    smokeCoverage: ["app:smoke-gameplay"],
	    knownBlockers: ["dismiss_done_write_service_pending"],
	    proofFiles: ["gameplay-smoke-proof.json"],
	    writeSafety: "not_applicable",
	    multiplayerReady: true,
	    sandboxOnly: true,
    ...
    testCoverage: ["room-flow-controller.test.ts"],
    smokeCoverage: ["app:smoke-gameplay", "app:smoke-multiplayer-e2e"],
  ...
  },
  {
    ...
    knownBlockers: ["server_authoritative_apply_api_pending", "negotiation_accept_reject_flow_needs_full_e2e"],
    proofFiles: ["gameplay-smoke-proof.json"],
    writeSafety: "covered",
    multiplayerReady: false,
    sandboxOnly: true,
  ...
  },
  {
    ...
    smokeCoverage: ["app:smoke-gameplay", "app:smoke-gameplay-write"],
    knownBlockers: ["server_authoritative_apply_api_pending", "contract_and_trust_sell_reasons_need_more_regression"],
    proofFiles: ["gameplay-smoke-proof.json"],
    writeSafety: "covered",
    multiplayerReady: false,
    sandboxOnly: true,
  ...
  },
  {
    ...
    smokeCoverage: ["app:smoke-gameplay"],
    knownBlockers: ["server_authoritative_facility_apply_pending"],
    proofFiles: ["gameplay-smoke-proof.json"],
    writeSafety: "covered",
    multiplayerReady: false,
    sandboxOnly: true,
  ...
  },
  {
    ...
    category: "Facilities",
    status: "local_write",
    views: ["training", "preseason", "season"],
  ...
  },
  {
    ...
    smokeCoverage: ["app:smoke-gameplay-write"],
    knownBlockers: ["server_authoritative_resolve_pending"],
    proofFiles: ["season2-simulation-summary.json", "season2-matchday-results.csv"],
    writeSafety: "covered",
    multiplayerReady: false,
    sandboxOnly: true,
    prodReady: false,
  ...
  },
  {
    ...
    status: "preview",
    views: ["home", "teams", "seasonReview"],
    writePaths: ["lib/board/team-season-objectives-service.ts"],
    testCoverage: ["team-season-objectives-service.test.ts"],
    smokeCoverage: ["smoke_missing"],
    knownBlockers: ["sponsor_objective_source_missing", "objective_apply_rewards_pending"],
    proofFiles: [],
    writeSafety: "not_applicable",
    multiplayerReady: false,
    sandboxOnly: true,
  ...
  },
  {
    ...
    status: "preview",
    views: ["market", "drawer", "training"],
    writePaths: ["preview only"],
    testCoverage: ["test_missing"],
    smokeCoverage: ["smoke_missing"],
    knownBlockers: ["real_scouting_source_missing", "potential_history_calibration_pending"],
    proofFiles: [],
    writeSafety: "not_applicable",
    multiplayerReady: false,
    sandboxOnly: true,
  ...
  },
  {
    ...
    category: "UI Infrastructure",
    status: "sandbox_ready",
    views: ["season", "market", "teams", "ranks", "training", "cockpit"],
