...
const registry: RegistryInput[] = [
  ...
  {
    featureId: "season-end-organic-progression",
    label: "Season-End Organic Progression",
    category: "XP / Progression",
    status: "local_write",
    views: ["trainingV2", "drawer"],
    writePaths: ["lib/progression/season-end-xp-apply-service.ts", "lib/progression/season-end-progression-batch.ts"],
    testCoverage: ["season-end-xp-apply-service.test.ts", "season-end-progression-batch.test.ts"],
    smokeCoverage: ["app:smoke-gameplay"],
    knownBlockers: [],
