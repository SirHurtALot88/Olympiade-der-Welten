 ...
 * Standard (komfortabel schmaler, ~15"-MacBook-Gefühl) oder Cinema (volle
 * Breite eines großen 32"-16:9-Monitors).
 *
 ...
 */
export type ViewWidthMode = "standard" | "cinema";
...
const VALID_MODES: readonly ViewWidthMode[] = ["standard", "cinema"];
