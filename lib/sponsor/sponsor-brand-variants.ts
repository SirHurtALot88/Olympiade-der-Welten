...
const CORE_BLUEPRINTS: VariantBlueprint[] = [
  {
    ...
    archetype: "security",
    tierRange: [1, 3],
    flavorSuffix: "Sicherheits-Paket — hohe Basis, moderate Boni",
    baseCash: 10,
    rankCash: 3,
    improvementCash: 2,
    specialCash: 3,
  },
  {
    ...
    tierRange: [2, 5],
    flavorSuffix: "Leistungs-Paket — wenig Basis, hohe Platzierungsboni",
    baseCash: 4,
    rankCash: 8,
    improvementCash: 5,
    specialCash: 5,
  },
  {
    ...
    archetype: "identity",
    tierRange: [1, 4],
    flavorSuffix: "Identitäts-Paket — starkes Sonderziel passend zur Marke",
    baseCash: 6,
    rankCash: 5,
    improvementCash: 3,
    specialCash: 6,
  },
  {
    ...
    archetype: "performance",
    tierRange: [4, 5],
    flavorSuffix: "Premium-Elite — anspruchsvolle Ziele, Top-Cash",
    baseCash: 5,
    rankCash: 10,
    improvementCash: 6,
    specialCash: 7,
