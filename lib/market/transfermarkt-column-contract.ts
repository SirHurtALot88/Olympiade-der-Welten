...
export const TRANSFERMARKT_COLUMN_CONTRACT: TransfermarktColumnContractEntry[] = [
  ...
  { id: "currentAbilityTier", label: "CA", dataKey: "currentAbilityTier", group: "core", teamDependent: false, defaultWidth: 72, minWidth: 62 },
  ...
  { id: "developmentTrend", label: "Dev", dataKey: "developmentTrend", group: "core", teamDependent: false, defaultWidth: 110, minWidth: 90 },
