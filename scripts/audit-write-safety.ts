...
const entries: WriteSafetyEntry[] = [
  {
    path: "lib/game/new-game-setup-service.ts",
    category: "new game local save creation",
    defaultMode: "dry-run",
    writeGate: "confirm-token",
    allowedTables: ["new local save", "local scenarioMeta", "local teamControlSettings", "local start standings"],
    forbiddenTables: ["Prisma", "remote database", "existing save overwrite", "direct roster insert outside seed"],
    secretsSafe: true,
    explicitRemoteWriteRequired: false,
  },
  {
    path: "app/api/new-game/route.ts",
    category: "new game setup api",
    defaultMode: "dry-run",
    writeGate: "confirm-token",
    allowedTables: ["new local save", "local scenarioMeta", "local teamControlSettings", "local start standings"],
    forbiddenTables: ["Prisma", "remote database", "existing save overwrite"],
    secretsSafe: true,
    explicitRemoteWriteRequired: false,
  },
  {
  ...
  {
    path: "lib/ai/chunked-redraft-topup-service.ts",
    category: "chunked season 1 redraft/top-up",
    defaultMode: "dry-run",
    writeGate: "confirm-token",
    allowedTables: ["local Team.cash", "local rosters", "local transferHistory", "local output files"],
    forbiddenTables: ["Prisma ActivePlayer", "Prisma Transfer", "Prisma TeamSeasonState", "remote database", "Result", "Standings"],
    secretsSafe: true,
    explicitRemoteWriteRequired: false,
  },
  {
  ...
  {
    path: "scripts/export-redraft-performance-acceptance.ts",
    category: "redraft performance acceptance export",
    defaultMode: "read-only",
    writeGate: "n/a",
    allowedTables: ["local output files"],
    forbiddenTables: ["Prisma", "remote database", "SQLite writes", "rosters", "transferHistory", "Team.cash"],
    secretsSafe: true,
    explicitRemoteWriteRequired: false,
  },
  {
    path: "scripts/export-redraft-acceptance-gate.ts",
    category: "redraft season-ready acceptance gate",
    defaultMode: "read-only",
    writeGate: "n/a",
    allowedTables: ["local output files", "local scenarioMeta only when GREEN"],
    forbiddenTables: ["Prisma", "remote database", "rosters", "transferHistory", "Team.cash", "balancing values"],
    secretsSafe: true,
    explicitRemoteWriteRequired: false,
  },
  {
  ...
  {
    path: "lib/facilities/facility-maintenance-service.ts",
    category: "facility maintenance local service",
    defaultMode: "dry-run",
    writeGate: "confirm-token",
    allowedTables: ["local Team.cash", "local SeasonState.teamFacilities", "local SeasonState.facilityEvents"],
    forbiddenTables: ["Prisma ActivePlayer", "Prisma Transfer", "Prisma TeamSeasonState", "Result", "Standings"],
  ...
  {
    path: "lib/training/training-settings-service.ts",
    category: "team training settings local service",
    defaultMode: "dry-run",
    writeGate: "confirm-token",
    allowedTables: ["local Player.trainingMode", "local SeasonState.aiManagerTrainingSettings"],
    forbiddenTables: ["Prisma", "remote database", "Team.cash", "Transfer", "Result", "Standings"],
    secretsSafe: true,
    explicitRemoteWriteRequired: false,
  },
  {
    path: "lib/ai/ai-manager-apply-service.ts",
    category: "ai manager apply orchestrator",
    defaultMode: "dry-run",
    writeGate: "dryRun=false",
    allowedTables: [
      "local SeasonState.aiManagerBudgetReservations",
      "local SeasonState.aiManagerContractStrategies",
      "local SeasonState.aiManagerSellStrategies",
      "local training settings via training-settings-service",
      "local facilities via facility services",
    ],
    forbiddenTables: ["Prisma", "remote database", "direct transfer writes", "direct lineup writes", "Result", "Standings"],
    secretsSafe: true,
    explicitRemoteWriteRequired: false,
  },
  {
    path: "lib/ai/ai-season-lifecycle-orchestrator.ts",
    category: "ai season lifecycle orchestrator",
    defaultMode: "read-only",
    writeGate: "n/a",
    allowedTables: ["local phase status preview", "local manager memory preview", "local output files"],
    forbiddenTables: ["Prisma", "remote database", "direct transfers", "direct lineups", "direct facilities", "direct training", "season long-run"],
    secretsSafe: true,
    explicitRemoteWriteRequired: false,
  },
  {
    path: "lib/ai/ai-manager-doctrine-service.ts",
    category: "ai manager doctrine and identity guard",
    defaultMode: "read-only",
    writeGate: "n/a",
    allowedTables: ["local doctrine preview", "local identity guard preview", "local manager review preview", "local output files"],
    forbiddenTables: ["Prisma", "remote database", "direct transfers", "direct lineups", "direct facilities", "direct training", "season long-run"],
    secretsSafe: true,
    explicitRemoteWriteRequired: false,
  },
  {
    path: "lib/ai/ai-manager-integration-contract.ts",
    category: "ai manager integration contract",
    defaultMode: "read-only",
    writeGate: "n/a",
    allowedTables: ["local integration contract preview", "local output files"],
    forbiddenTables: ["Prisma", "remote database", "direct transfers", "direct lineups", "direct facilities", "direct training", "season long-run"],
    secretsSafe: true,
    explicitRemoteWriteRequired: false,
  },
  {
    path: "app/api/facilities/maintenance/route.ts",
    category: "facility maintenance api",
    defaultMode: "dry-run",
    writeGate: "dryRun=false",
    allowedTables: ["local Team.cash", "local SeasonState.teamFacilities", "local SeasonState.facilityEvents"],
    forbiddenTables: ["Prisma ActivePlayer", "Prisma Transfer", "Prisma TeamSeasonState", "Result", "Standings"],
  ...
  {
    path: "lib/board/team-season-objectives-service.ts",
    category: "board objectives presenter and ai bias service",
    defaultMode: "read-only",
    writeGate: "n/a",
    allowedTables: [],
    forbiddenTables: ["Prisma", "remote database", "local Team.cash", "rosters", "transferHistory", "season transition"],
    secretsSafe: true,
    explicitRemoteWriteRequired: false,
  },
  {
    path: "lib/contracts/contract-renewal-service.ts",
    category: "contract renewal and season-end tick local service",
    defaultMode: "dry-run",
    writeGate: "confirm-token",
    allowedTables: ["local rosters.contractLength", "local rosters.salary", "local SeasonState.contractEvents"],
    forbiddenTables: ["Prisma", "remote database", "local Team.cash", "market value direct write", "transferHistory direct insert"],
    secretsSafe: true,
    explicitRemoteWriteRequired: false,
  },
  {
    path: "app/api/contracts/renewal/route.ts",
    category: "contract renewal local API route",
    defaultMode: "dry-run",
    writeGate: "confirm-token",
    allowedTables: ["local rosters.contractLength", "local rosters.salary", "local SeasonState.contractEvents"],
    forbiddenTables: ["Prisma", "remote database", "local Team.cash", "market value direct write", "transferHistory direct insert"],
  ...
  },
  {
    ...
    defaultMode: "dry-run",
    writeGate: "confirm-token",
    allowedTables: ["local Season", "local MatchdayState", "local SeasonState", "local GameLog", "local rosters via contract service"],
  ...
  {
    path: "lib/server/server-save-migration.ts",
    category: "server save migration contract",
    defaultMode: "read-only",
    writeGate: "n/a",
    allowedTables: [],
    forbiddenTables: ["Prisma", "remote database", "SQLite writes", "direct inserts"],
    secretsSafe: true,
    explicitRemoteWriteRequired: true,
  },
  {
    path: "scripts/export-server-persistence-readiness-audit.ts",
    category: "server persistence readiness audit export",
    defaultMode: "read-only",
    writeGate: "n/a",
    allowedTables: ["local output files"],
    forbiddenTables: ["Prisma", "remote database", "SQLite writes", "direct inserts"],
  ...
  {
    path: "scripts/export-feature-audit-matrix.ts",
    category: "feature audit matrix export",
    defaultMode: "read-only",
    writeGate: "n/a",
    allowedTables: ["local output files"],
    forbiddenTables: ["Prisma", "remote database", "SQLite writes", "direct inserts"],
  ...
  {
    path: "scripts/smoke-multiplayer-e2e.ts",
    category: "multiplayer browser e2e room smoke",
    defaultMode: "read-only",
    writeGate: "n/a",
    allowedTables: ["in-memory room state", "local proof output files"],
    forbiddenTables: ["Prisma", "remote database", "SQLite save writes", "rosters", "transferHistory", "cash", "lineups"],
    secretsSafe: true,
    explicitRemoteWriteRequired: true,
  },
  {
