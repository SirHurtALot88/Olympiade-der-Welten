  ...
  try {
    ...
    steps.push(await runStep({
      ...
      run: async (step) => {
        ...
        assertStep(step, hasAny(text, ["Top Steigerer", "Groesstes Risiko", "Kein aktiver Kader", "Upgrade bereit", "Rückschritt-Risiko", "Netto-Forecast"]), "Spieler-Forecast ist sichtbar.");
