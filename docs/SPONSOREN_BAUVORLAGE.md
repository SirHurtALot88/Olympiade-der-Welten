...
| 9 | **MESSLAUF DA (11.08.), Freigabe-Kriterium NICHT erfüllt.** `scripts/messlauf-sponsoren-gebaeude.ts`. Am frischen Spiel: Angebot 160 Karten (32 reine Cash, Gebäude 32/64/32 klein/mittel/groß), Verzicht-Spanne **0,8 .. 25,4 C** (Median 6,0). KI-Wahl: **8 von 32** reine Cash-Karte, Gebäude 2/15/7; Zielarten 15× Frische, 9× Achsen-Rang, 8× keins. **Σ Sponsorgeld 1694,6 C gegen Σ Gehälter 2020,0 C = 84 % Deckung** — das Kriterium „Σ Sponsoren deckt Σ Gehälter" ist **nicht** erfüllt. Die Gegenrechnung sagt, woran es liegt: der gewählte Cash-Verzicht beträgt 195,9 C, ohne ihn wären es **94 %**. Rund zwei Drittel der Lücke sind also bewusst gekauft (E5, Rubberband), ein Drittel ist eine Leiter, die schon vorher knapp unter 100 % lag. **Das ist eine Entscheidung für Chris, keine stille Reparatur:** die Leiter anzuheben würde genau das Rubberband abschwächen, das er ausdrücklich will. **Nicht gemessen:** die Uptime der Rangmarken über die Spieltage und die Erfüllungsquote der zwei Ziele — beides braucht eine gespielte Saison, nicht einen Abschluss gegen einen Endstand. | `scripts/messlauf-sponsoren-gebaeude.ts` | s. o. |
