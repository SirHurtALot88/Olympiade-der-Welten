...
| 5 | **Settlement — durch E1 fast leer geworden.** Die hier ursprünglich geplante Leih-Abzug-Zeile gibt es nicht mehr: der Verzicht steckt seit Schritt 4 in der Leiter, das Settlement liest ihn also bereits mit und darf keine zweite Buchung machen. **Was übrig bleibt:** die Bonus-Zeile der Rangmarke (hängt an Schritt 6) und der Nachweis „Kasse ändert sich um exakt den angezeigten Betrag" für eine Gebäude-Karte. | `sponsor-settlement-service.ts`, ggf. Parts-Builder in `sponsor-v3-offer-service.ts`, Tests | Altverträge zahlen zeichenidentisch weiter (Regressionstest); Anzeige-==-Settlement-Test für den neuen Pfad („Kasse ändert sich um exakt den angezeigten Betrag", Muster aus Q1/P-Tabelle) |
...
**Warum Schritt 7 die wichtigste Lücke ist und nicht einfach der nächste Punkt:** Nachgemessen im
...
laufen soll. Schritt 7 gehört deshalb VOR Schritt 6 und 8.
