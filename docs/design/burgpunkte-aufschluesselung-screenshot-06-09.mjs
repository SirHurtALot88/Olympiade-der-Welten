// Sichtpruefung der Burgpunkte-Aufschluesselung im Takeshi-Endstand (06.09.).
//   node burgpunkte-aufschluesselung-screenshot-06-09.mjs <repo>/public <ausgabeordner>
...
try {
  ...
  await el.screenshot({ path: `${OUT}/endstand-${disc}-aufschluesselung-06-09.png` });
