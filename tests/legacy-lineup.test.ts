...
describe("legacy lineup draft ui contract", () => {
  it("keeps draft workspace as primary with captain strip, progress and quick assign", async () => {
    ...
    expect(lineupText).toContain("Im Formplan bearbeiten");
    expect(lineupText).toContain("legacy-lineup-draft-tactics-form-readonly");
    expect(lineupText).toMatch(/legacy-lineup-draft-tactics[\s\S]*Im Formplan bearbeiten/);
    ...
    expect(lineupText).toContain("legacy-lineup-team-tactics-form-readonly");
    ...
    expect(cssText).toContain(".legacy-lineup-draft-intensity-preview");
