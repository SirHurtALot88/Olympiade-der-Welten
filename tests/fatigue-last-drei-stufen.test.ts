 ...
 * Teams, 10 Spieltage): Last 10 → 63 Verletzungen je Saison, Last 13 → 124, Last 15 → 199 (der
 ...
 *
 * ENDSTAND nach Chris' Ansage („erhöhe mal um 30% … ich meine von 10 auf 13 usw"): 13.
 *
...
describe("Die Last reicht jetzt bis in die Risikozone", () => {
   ...
   * bleibt: 13 × 1,4 = 18,2. Ab einer Basis über 17,8 (17,8 × 1,4 = 24,9) waere das nicht mehr so —
