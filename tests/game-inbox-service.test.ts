...
describe("game inbox service", () => {
  ...
  it("solvency warning uses the persisted beliebtheit (same factor as the facility-season-end credit), not the stateless league value (#7)", () => {
    ...
    // Niedrige Beliebtheit (0.5 → Arena-Einnahme 14.25): -10 + 14.25 - 5.4 = -1.15 < 0 → Warnung FEUERT.
    ...
    // Hohe Beliebtheit (1.5 → Arena-Einnahme 42.75): -10 + 42.75 - 5.4 = 27.35 > 0 → Warnung feuert NICHT.
